...
use App\Domain\BankAccount\Service\DeleteBankAccountService;
...
final class DeleteBankAccountAction
{
    ...
    public function invoke(ServerRequestContract $requestHandler): ServerResponseHandler
    {
        ...
        try {
            ...
            $bankingService = new DeleteBankAccountService($container->get(PDO::class));
            $response = $bankingService->deleteBankAccount(array_merge($data, $sessionData));
