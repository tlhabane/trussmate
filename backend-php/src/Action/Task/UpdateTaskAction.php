...
use App\Domain\Task\Service\UpdateTask\UpdateTaskService;
...
final class UpdateTaskAction
{
    ...
    public function invoke(ServerRequestContract $requestHandler): ServerResponseHandler
    {
        ...
        try {
            ...
            $taskService = new UpdateTaskService($container->get(PDO::class));
            $response = $taskService->updateTask(array_merge($data, $sessionData));
