...
namespace App\Action\ContactPerson;

use App\Domain\ContactPerson\Service\UpdateContact\UpdateContactPersonService;
...
final class UpdateContactPersonAction
{
    /**
     * @throws Exception
     */
    public function invoke(ServerRequestContract $requestHandler): ServerResponseHandler
    {
        ...
        try {
            ...
            $contactService = new UpdateContactPersonService($container->get(PDO::class));
            $response = $contactService->updateContact(array_merge($data, $sessionData));
