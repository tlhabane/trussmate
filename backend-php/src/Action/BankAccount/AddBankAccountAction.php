...
use App\Domain\BankAccount\Service\AddBankAccount\AddBankAccountService;
...
final class AddBankAccountAction
{
    ...
    public function invoke(ServerRequestContract $requestHandler): ServerResponseHandler
    {
        ...
        try {
            ...
            $bankingService = new AddBankAccountService($container->get(PDO::class));
            $response = $bankingService->addBankAccount(array_merge($data, $sessionData));
