...
use App\Domain\Sale\Service\UpdateSale\UpdateSaleService;
...
final class UpdateSaleAction
{
    ...
    public function invoke(ServerRequestContract $requestHandler): ServerResponseHandler
    {
        ...
        try {
            ...
            $saleService = new UpdateSaleService($container->get(PDO::class));
            $response = $saleService->updateSale(array_merge($data, $sessionData));
