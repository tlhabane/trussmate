...
use App\Domain\TaskMonitor\Service\UpdateTaskMonitorService;
...
final class UpdateTaskMonitorAction
{
    /**
     * @throws Exception
     */
    public function invoke(ServerRequestContract $requestHandler): ServerResponseHandler
    {
        ...
        try {
            ...
            $service = new UpdateTaskMonitorService($container->get(PDO::class));
            $response = $service->updateTaskMonitor(array_merge($data, $sessionData));
