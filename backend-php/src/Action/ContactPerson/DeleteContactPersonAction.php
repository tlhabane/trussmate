...
use App\Domain\ContactPerson\Service\DeleteContact\DeleteContactService;
...
final class DeleteContactPersonAction
{
    /**
     * @throws Exception
     */
    public function invoke(ServerRequestContract $requestHandler): ServerResponseHandler
    {
        ...
        try {
            ...
            $contactService = new DeleteContactService($container->get(PDO::class));
            $response = $contactService->deleteContact(array_merge($data, $sessionData));
