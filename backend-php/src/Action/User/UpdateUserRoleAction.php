...
use App\Domain\User\Service\UpdateUserRole\UpdateUserRoleService;
...
final class UpdateUserRoleAction
{
    ...
    public function invoke(ServerRequestContract $requestHandler): ServerResponseHandler
    {
        ...
        try {
            ...
            $userService = new UpdateUserRoleService($container->get(PDO::class));
            $response = $userService->updateUserRole(array_merge($data, $sessionData));
