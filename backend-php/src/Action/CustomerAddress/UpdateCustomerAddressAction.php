...
use App\Domain\CustomerAddress\Service\UpdateCustomerAddressService;
...
final class UpdateCustomerAddressAction
{
    ...
    public function invoke(ServerRequestContract $requestHandler): ServerResponseHandler
    {
        ...
        try {
            ...
            $addressService = new UpdateCustomerAddressService($container->get(PDO::class));
            $response = $addressService->updateAddress(array_merge($data, $sessionData));
