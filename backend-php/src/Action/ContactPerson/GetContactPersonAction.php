...
final class GetContactPersonAction
{
    /**
     * @throws Exception
     */
    public function invoke(ServerRequestContract $requestHandler): ServerResponseHandler
    {
        ...
        try {
            ...
            $contactService = new GetContactPersonService($container->get(PDO::class));
            $response = $contactService->getContact(array_merge($data, $sessionData));
