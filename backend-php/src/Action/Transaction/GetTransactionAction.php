...
use App\Domain\Transaction\Service\GetTransactionService;
...
final class GetTransactionAction
{
    /**
     * @throws Exception
     */
    public function invoke(ServerRequestContract $requestHandler): ServerResponseHandler
    {
        ...
        try {
            ...
            $service = new GetTransactionService($container->get(PDO::class));
            $response = $service->getTransaction(array_merge($data, $sessionData));
