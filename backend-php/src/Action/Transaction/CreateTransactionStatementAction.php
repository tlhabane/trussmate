...
use App\Domain\Transaction\Service\CreateTransactionStatementService;
...
final class CreateTransactionStatementAction
{
    /**
     * @throws Exception
     */
    public function invoke(ServerRequestContract $requestHandler): ServerResponseHandler
    {
        ...
        try {
            ...
            $service = new CreateTransactionStatementService($container->get(PDO::class));
            $response = $service->createStatement(array_merge($data, $sessionData));
