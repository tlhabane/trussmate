...
final class GetSaleDocumentAction
{
    /**
     * @throws Exception
     */
    public function invoke(ServerRequestContract $requestHandler): ServerResponseHandler
    {
        ...
        try {
            ...
            $documentService = new GetSaleDocumentService($container->get(PDO::class));
            $response = $documentService->getSaleDocument(array_merge($data, $sessionData));
