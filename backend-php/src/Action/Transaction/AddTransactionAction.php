...
use App\Domain\Transaction\Service\AddTransactionService;
...
final class AddTransactionAction
{
    ...
    public function invoke(ServerRequestContract $requestHandler): ServerResponseHandler
    {
        ...
        try {
            ...
            $service = new AddTransactionService($container->get(PDO::class));
            $response = $service->addTransaction(array_merge($data, $sessionData));
