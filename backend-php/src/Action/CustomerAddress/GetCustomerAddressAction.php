...
final class GetCustomerAddressAction
{
    /**
     * @throws Exception
     */
    public function invoke(ServerRequestContract $requestHandler): ServerResponseHandler
    {
        ...
        try {
            ...
            $addressService = new GetCustomerAddressService($container->get(PDO::class));
            $response = $addressService->getAddress(array_merge($data, $sessionData));
