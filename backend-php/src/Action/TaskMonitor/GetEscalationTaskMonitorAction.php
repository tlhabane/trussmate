...
use App\Domain\TaskMonitor\Service\GetEscalationTaskMonitorService;
...
final class GetEscalationTaskMonitorAction
{
    /**
     * @throws Exception
     */
    public function invoke(ServerRequestContract $requestHandler): ServerResponseHandler
    {
        ...
        try {
            ...
            $service = new GetEscalationTaskMonitorService($container->get(PDO::class));
            $response = $service->getEscalationTask(array_merge($data, $sessionData));
