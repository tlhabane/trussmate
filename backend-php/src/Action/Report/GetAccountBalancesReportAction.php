...
use App\Domain\Report\Service\GetAccountBalancesReportService;
...
final class GetAccountBalancesReportAction
{
    /**
     * @throws Exception
     */
    public function invoke(ServerRequestContract $requestHandler): ServerResponseHandler
    {
        ...
        try {
            ...
            $service = new GetAccountBalancesReportService($container->get(PDO::class));
            $response = $service->getReport(array_merge($data, $sessionData));
