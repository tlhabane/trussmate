...
namespace App\Action\SaleDocument;

use App\Domain\SaleDocument\Service\DeleteAllSaleDocumentsService;
...
final class DeleteAllSaleDocumentsAction
{
    /**
     * @throws Exception
     */
    public function invoke(ServerRequestContract $requestHandler): ServerResponseHandler
    {
        ...
        try {
            ...
            $documentService = new DeleteAllSaleDocumentsService($container->get(PDO::class));
            $response = $documentService->deleteDocuments(array_merge($data, $sessionData));
