...
namespace App\Action\CustomerAddress;

use App\Domain\CustomerAddress\Service\DeleteCustomerAddress\DeleteCustomerAddressService;
...
final class DeleteCustomerAddressAction
{
    ...
    public function invoke(ServerRequestContract $requestHandler): ServerResponseHandler
    {
        ...
        try {
            ...
            $addressService = new DeleteCustomerAddressService($container->get(PDO::class));
            $response = $addressService->deleteAddress(array_merge($data, $sessionData));
