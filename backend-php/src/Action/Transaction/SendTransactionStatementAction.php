...
use App\Domain\Transaction\Service\SendTransactionStatementService;
...
final class SendTransactionStatementAction
{
    /**
     * @throws Exception
     */
    public function invoke(ServerRequestContract $requestHandler): ServerResponseHandler
    {
        ...
        try {
            ...
            $service = new SendTransactionStatementService($container->get(PDO::class));
            $response = $service->sendStatement(array_merge($data, $sessionData));
