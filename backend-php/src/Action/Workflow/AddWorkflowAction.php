...
namespace App\Action\Workflow;

use App\Domain\Workflow\Service\AddWorkflow\AddWorkflowService;
...
final class AddWorkflowAction
{
    ...
    public function invoke(ServerRequestContract $requestHandler): ServerResponseHandler
    {
        ...
        try {
            ...
            $workflowService = new AddWorkflowService($container->get(PDO::class));
            $response = $workflowService->addWorkflow(array_merge($data, $sessionData));
