...
final class GetBankAccountAction
{
    /**
     * @throws Exception
     */
    public function invoke(ServerRequestContract $requestHandler): ServerResponseHandler
    {
        ...
        try {
            ...
            $bankingService = new GetBankAccountService($container->get(PDO::class));
            $response = $bankingService->getBankAccount(array_merge($data, $sessionData));
