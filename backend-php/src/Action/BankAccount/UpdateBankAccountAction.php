...
use App\Domain\BankAccount\Service\UpdateBankAccount\UpdateBankAccountService;
...
final class UpdateBankAccountAction
{
    ...
    public function invoke(ServerRequestContract $requestHandler): ServerResponseHandler
    {
        ...
        try {
            ...
            $bankingService = new UpdateBankAccountService($container->get(PDO::class));
            $response = $bankingService->updateBankAccount(array_merge($data, $sessionData));
