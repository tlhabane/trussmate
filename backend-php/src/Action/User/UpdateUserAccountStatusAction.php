...
use App\Domain\User\Service\UpdateUserStatus\UpdateUserStatusService;
...
final class UpdateUserAccountStatusAction
{
    /**
     * @throws Exception
     */
    public function invoke(ServerRequestContract $requestHandler): ServerResponseHandler
    {
        ...
        try {
            ...
            $userService = new UpdateUserStatusService($container->get(PDO::class));
            $response = $userService->updateStatus(array_merge($data, $sessionData));
