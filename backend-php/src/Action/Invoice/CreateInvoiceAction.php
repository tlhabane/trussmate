...
use App\Domain\Invoice\Service\CreateInvoiceService;
...
final class CreateInvoiceAction
{
    ...
    public function invoke(ServerRequestContract $requestHandler): ServerResponseHandler
    {
        ...
        try {
            ...
            $service = new CreateInvoiceService($container->get(PDO::class));
            $response = $service->getInvoice(array_merge($data, $sessionData));
