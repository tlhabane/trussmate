...
use App\Domain\TaskMonitor\Service\AddTaskMonitorService;
...
final class AddTaskMonitorAction
{
    /**
     * @throws Exception
     */
    public function invoke(ServerRequestContract $requestHandler): ServerResponseHandler
    {
        ...
        try {
            ...
            $service = new AddTaskMonitorService($container->get(PDO::class));
            $response = $service->addTaskMonitor(array_merge($data, $sessionData));
