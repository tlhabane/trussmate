...
use App\Domain\TaskMonitor\Service\DeleteTaskMonitorService;
...
final class DeleteTaskMonitorAction
{
    /**
     * @throws Exception
     */
    public function invoke(ServerRequestContract $requestHandler): ServerResponseHandler
    {
        ...
        try {
            ...
            $service = new DeleteTaskMonitorService($container->get(PDO::class));
            $response = $service->deleteTaskMonitor(array_merge($data, $sessionData));
