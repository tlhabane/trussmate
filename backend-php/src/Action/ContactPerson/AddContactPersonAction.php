...
use App\Domain\ContactPerson\Service\AddContact\AddContactPersonService;
...
final class AddContactPersonAction
{
    /**
     * @throws Exception
     */
    public function invoke(ServerRequestContract $requestHandler): ServerResponseHandler
    {
        ...
        try {
            ...
            $contactService = new AddContactPersonService($container->get(PDO::class));
            $response = $contactService->addContact(array_merge($data, $sessionData));
