...
use App\Domain\User\Service\UpdateUserHash\UpdateUserHashService;
...
final class UpdateUserHashAction
{
    /**
     * @throws Exception
     */
    public function invoke(ServerRequestContract $requestHandler): ServerResponseHandler
    {
        ...
        try {
            ...
            $userService = new UpdateUserHashService($container->get(PDO::class));
            $response = $userService->updateHash(array_merge($data, $sessionData));
