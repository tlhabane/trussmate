...
use App\Domain\Report\Service\GetTaskAnalyticsReportService;
...
final class GetTaskAnalyticsReportAction
{
    /**
     * @throws Exception
     */
    public function invoke(ServerRequestContract $requestHandler): ServerResponseHandler
    {
        ...
        try {
            ...
            $service = new GetTaskAnalyticsReportService($container->get(PDO::class));
