...
use App\Domain\Report\Service\CreateAccountAgingReportDocumentService;
...
final class CreateAccountAgingReportDocumentAction
{
    /**
     * @throws Exception
     */
    public function invoke(ServerRequestContract $requestHandler): ServerResponseHandler
    {
        ...
        try {
            ...
            $service = new CreateAccountAgingReportDocumentService($container->get(PDO::class));
            $response = $service->createDocument(array_merge($data, $sessionData));
