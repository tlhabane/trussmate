...
use App\Domain\Task\Service\AddTask\AddTaskService;
...
final class AddTaskAction
{
    ...
    public function invoke(ServerRequestContract $requestHandler): ServerResponseHandler
    {
        ...
        try {
            ...
            $taskService = new AddTaskService($container->get(PDO::class));
            $response = $taskService->addTask(array_merge($data, $sessionData));
