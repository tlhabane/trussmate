...
use App\Domain\Sale\Service\CreateSaleQuotationService;
...
final class CreateSaleQuotationAction
{
    /**
     * @throws Exception
     */
    public function invoke(ServerRequestContract $requestHandler): ServerResponseHandler
    {
        ...
        try {
            ...
            $saleService = new CreateSaleQuotationService($container->get(PDO::class));
            $response = $saleService->getQuotation(array_merge($data, $sessionData));
