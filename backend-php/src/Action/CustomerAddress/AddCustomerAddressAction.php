...
final class AddCustomerAddressAction
{
    /**
     * @throws Exception
     */
    public function invoke(ServerRequestContract $requestHandler): ServerResponseHandler
    {
        ...
        try {
            ...
            $addressService = new AddCustomerAddressService($container->get(PDO::class));
            $response = $addressService->addAddress(array_merge($data, $sessionData));
