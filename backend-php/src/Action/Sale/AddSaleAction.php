...
use App\Domain\Sale\Service\AddSale\AddSaleService;
...
final class AddSaleAction
{
    ...
    public function invoke(ServerRequestContract $requestHandler): ServerResponseHandler
    {
        ...
        try {
            ...
            $saleService = new AddSaleService($container->get(PDO::class));
            ...
            $response = $saleService->addSale($serviceData);
