...
use App\Domain\User\Service\UpdateUserAccountInfo\UpdateUserAccountInfoService;
...
final class UpdateUserAccountInfoAction
{
    /**
     * @throws Exception
     */
    public function invoke(ServerRequestContract $requestHandler): ServerResponseHandler
    {
        ...
        try {
            ...
            $userService = new UpdateUserAccountInfoService($container->get(PDO::class));
            $response = $userService->updateAccountInfo(array_merge($data, $sessionData));
