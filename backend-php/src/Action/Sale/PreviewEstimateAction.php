...
use App\Domain\Sale\Service\PreviewEstimateService;
...
final class PreviewEstimateAction
{
    /**
     * @throws Exception
     */
    public function invoke(ServerRequestContract $requestHandler): ServerResponseHandler
    {
        ...
        try {
            ...
            $saleService = new PreviewEstimateService($container->get(PDO::class));
            $response = $saleService->preview(array_merge($data, $sessionData));
