...
use App\Domain\SaleTask\Service\UpdateSaleTask\UpdateSaleTaskService;
...
final class UpdateSaleTaskAction
{
    /**
     * @throws Exception
     */
    public function invoke(ServerRequestContract $requestHandler): ServerResponseHandler
    {
        ...
        try {
            ...
            $taskService = new UpdateSaleTaskService($container->get(PDO::class));
            ...
            $response = $taskService->updateTask($serviceData);
