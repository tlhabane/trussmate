...
final class GetSaleTaskListAction
{
    /**
     * @throws Exception
     */
    public function invoke(ServerRequestContract $requestHandler): ServerResponseHandler
    {
        ...
        try {
            ...
            $taskService = new GetSaleTaskListService($container->get(PDO::class));
            $response = $taskService->getTask(array_merge($data, $sessionData));
