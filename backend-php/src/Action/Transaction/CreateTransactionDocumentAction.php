...
use App\Domain\Transaction\Service\CreateTransactionDocumentService;
...
final class CreateTransactionDocumentAction
{
    /**
     * @throws Exception
     */
    public function invoke(ServerRequestContract $requestHandler): ServerResponseHandler
    {
        ...
        try {
            ...
            $service = new CreateTransactionDocumentService($container->get(PDO::class));
