...
final class AddInvoiceAction
{
    ...
    public function invoke(ServerRequestContract $requestHandler): ServerResponseHandler
    {
        ...
        try {
            ...
            $invoiceService = new AddInvoiceService($container->get(PDO::class));
            $response = $invoiceService->addInvoice(array_merge($data, $sessionData));
