...
final class SendSaleQuotationAction
{
    /**
     * @throws Exception
     */
    public function invoke(ServerRequestContract $requestHandler): ServerResponseHandler
    {
        ...
        try {
            ...
            $saleService = new SendSaleQuotationService($container->get(PDO::class));
            $response = $saleService->sendQuotation(array_merge($data, $sessionData));
