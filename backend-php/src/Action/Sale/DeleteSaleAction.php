...
use App\Domain\Sale\Service\DeleteSale\DeleteSaleService;
...
final class DeleteSaleAction
{
    ...
    public function invoke(ServerRequestContract $requestHandler): ServerResponseHandler
    {
        ...
        try {
            ...
            $saleService = new DeleteSaleService($container->get(PDO::class));
            $response = $saleService->deleteSale(array_merge($data, $sessionData));
