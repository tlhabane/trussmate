...
use App\Domain\Transaction\Service\CancelTransaction\CancelTransactionService;
...
final class CancelTransactionAction
{
    ...
    public function invoke(ServerRequestContract $requestHandler): ServerResponseHandler
    {
        ...
        try {
            ...
            $service = new CancelTransactionService($container->get(PDO::class));
            $response = $service->cancelTransaction(array_merge($data, $sessionData));
