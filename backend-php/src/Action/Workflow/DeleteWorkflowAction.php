...
use App\Domain\Workflow\Service\DeleteWorkflowService;
...
final class DeleteWorkflowAction
{
    ...
    public function invoke(ServerRequestContract $requestHandler): ServerResponseHandler
    {
        ...
        try {
            ...
            $workflowService = new DeleteWorkflowService($container->get(PDO::class));
            $response = $workflowService->deleteWorkflow(array_merge($data, $sessionData));
