...
use App\Domain\Workflow\Service\UpdateWorkflow\UpdateWorkflowService;
...
final class UpdateWorkflowAction
{
    ...
    public function invoke(ServerRequestContract $requestHandler): ServerResponseHandler
    {
        ...
        try {
            ...
            $workflowService = new UpdateWorkflowService($container->get(PDO::class));
            $response = $workflowService->updateWorkflow(array_merge($data, $sessionData));
