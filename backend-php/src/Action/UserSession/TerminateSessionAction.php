...
namespace App\Action\UserSession;
...
final class TerminateSessionAction
{
    ...
    public function invoke(ServerRequestContract $requestHandler): ServerResponseHandler
    {
        ...
        try {
            ...
            $sessionService = new TerminateSessionService($container->get(PDO::class));
            $response = $sessionService->terminateSession(array_merge($data, $sessionData));
