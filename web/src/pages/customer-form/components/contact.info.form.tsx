...
import { Button, ContactFormElements } from '../../../components';
...
export const ContactInfoForm: React.FC<Props> = (props): JSX.Element => {
    const {
        formConfig,
        formInvalid,
        getElement,
                        ...
                        <div className='form-group mt-3 mb-3'>
                            <div className='row'>
                                <div className='col-3 pr-sm-0 pl-sm-0'>
                                    <Button type='button' className='btn-default btn-block' data-tab='customer-info'
                                            onClick={onSwitchTabHandler}>
                                        Back
                                    </Button>
                                </div>
                                <div className='col-8 offset-1 pr-sm-0 pl-sm-0'>
                                    <Button type='submit' className='btn-success btn-block' disabled={formInvalid}>
